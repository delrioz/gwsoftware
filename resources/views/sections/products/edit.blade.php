                ...
                <div class="container"  style="box-shadow: 0 4px 12px 0 rgba(0, 0, 2, 0.2), 0 7px 20px 0 rgba(0, 0, 0, 0.19)">
                    <div class="row ">
                        <div class="col-md-12 py-5 border">
                            <h4 class="pb-2" style="color:black;">Editing a Product.</h4>
                              ...
                              <label for="" style="text-align:center;">SKU</label>
                                    <input id="SKU" name="SKU"
                                            ...
                                            value = "{{$allproducts->SKU}}" required>
                                    </div>
                                </div>
                                <div class="form-row">
                                <div class="form-group col-md-6">
                          ...
                          <div class="form-row">
                                  ...
                                  <input id="Sell_PriceVat" name="Sell_PriceVat"
                                          ...
                                          type="hidden" value="{{$Sell_PriceVat}}"
                                            required  >
                            ...
                            @if(count($allmachines)  > 0)
                                <div class="form-group">
                                    <div class="form-group col-md-12">
                                      ...
                                      <select id="mselect" multiple style="width:300px;"  name="Machinesoptions[]">
                                    @if($statusNulo == false)
                                      @foreach($respostaMachines as $machines)
                                        <option id="option" value="{{$machines->id}}">{{$machines->model}}</option>
                                      @endforeach

                                      @foreach($outrasop as $op)
                                      <option id="option" value="{{$op->machine_id}}" selected>{{$op->modelMachine}}</option>
                                      @endforeach
                                    @endif
                              ...
                              <div class="form-row">
                                      <label for="" style="color:black;"> About: </label>
                                          ...
                                          <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                                              name="about" placeholder="about" id="about" value="{{$allproducts->about}}">{{$allproducts->about}}</textarea>
                              </div>
...
<script>
    ...
    $(document).ready(function(){
      $.ajax({
        url: '/section/products/takingdatas',
        method: 'POST',
        data:{ 
          id:1,
      ...
      // alert(res);
        ...
        for(var x=0; x<arreglo.length; x++){
            ...
            productos.push(arreglo[x].model);
