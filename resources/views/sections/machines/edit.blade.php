                            ...
                            <h4 class="pb-2" style="color:black;">Editing a Machine. Please, fill out the form.</h4>
                                ...
                                <div class="form-row">
                                        <label for="" style="color:black;"> Customer Report: </label>
                                            ...
                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="customer_report" placeholder="customer_report" id="customer_report">{{$allmachines-> customer_report}}</textarea>
                                            </div>
                                </div>
                                <div class="form-row">
                                        <label for="" style="color:black;"> Observations: </label>
                                            <div class="form-group col-md-12">
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="first_observations" placeholder="first_observations" id="first_observations">{{$allmachines-> first_observations}}</textarea>
                                          </div>
                                </div>
